...
Examples showing how to use the producer are given in the [javadocs](/static/0102/javadoc/index.html?org/apache/kafka/clients/producer/KafkaProducer.html "Kafka 0.10.2 Javadoc"). 
...
Examples showing how to use the consumer are given in the [javadocs](/static/0102/javadoc/index.html?org/apache/kafka/clients/consumer/KafkaConsumer.html "Kafka 0.10.2 Javadoc"). 
...
Examples showing how to use this library are given in the [javadocs](/static/0102/javadoc/index.html?org/apache/kafka/streams/KafkaStreams.html "Kafka 0.10.2 Javadoc")

Additional documentation on using the Streams API is available [here](/0102/streams). 
...
Those who want to implement custom connectors can see the [javadoc](/static/0102/javadoc/index.html?org/apache/kafka/connect "Kafka 0.10.2 Javadoc"). 

...
For a complete list of available API functionality, see the [Streams](/static/22/javadoc/org/apache/kafka/streams/package-summary.html) API docs.
...
Persistent `KeyValueStore<K, V>` | RocksDB | Yes (enabled by default) | 
  ...
  * Available [store variants](/static/22/javadoc/org/apache/kafka/streams/state/Stores.PersistentKeyValueFactory.html): time window key-value store, session window key-value store.
...
[Previous](/22/streams/developer-guide/dsl-api) [Next](/22/streams/developer-guide/datatypes)

...
![](/25/images/streams-interactive-queries-03.png)
...
![](/25/images/streams-interactive-queries-api-01.png)
...
![](/25/images/streams-interactive-queries-api-02.png)
...
The following methods return [StreamsMetadata](/static/25/javadoc/org/apache/kafka/streams/state/StreamsMetadata.html) objects, which provide meta-information about application instances such as their RPC endpoint and locally available state stores.
...
If `application.server` is not configured for an application instance, then the above methods will not find any [StreamsMetadata](/static/25/javadoc/org/apache/kafka/streams/state/StreamsMetadata.html) for it.
...
[Previous](/25/streams/developer-guide/testing) [Next](/25/streams/developer-guide/memory-mgmt)

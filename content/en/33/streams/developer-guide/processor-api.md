...
For a complete list of available API functionality, see the [Streams](/static/33/javadoc/org/apache/kafka/streams/package-summary.html) API docs.
...
Persistent `KeyValueStore<K, V>` | RocksDB | Yes (enabled by default) | 
  ...
  * Available [store variants](/static/33/javadoc/org/apache/kafka/streams/state/Stores.html#persistentKeyValueStore-java.lang.String-): time window key-value store, session window key-value store.
  * Use [persistentTimestampedKeyValueStore](/static/33/javadoc/org/apache/kafka/streams/state/Stores.html#persistentTimestampedKeyValueStore-java.lang.String-) when you need a persistent key-(value/timestamp) store that supports put/get/delete and range queries.
  * Use [persistentTimestampedWindowStore](/static/33/javadoc/org/apache/kafka/streams/state/Stores.html#persistentTimestampedWindowStore-java.lang.String-java.time.Duration-java.time.Duration-boolean-) when you need a persistent windowedKey-(value/timestamp) store.
...
In-memory `KeyValueStore<K, V>` | - | Yes (enabled by default) | 
  ...
  * Available [store variants](/static/33/javadoc/org/apache/kafka/streams/state/Stores.html#inMemoryKeyValueStore-java.lang.String-): time window key-value store, session window key-value store.
  * Use [TimestampedKeyValueStore](/static/33/javadoc/org/apache/kafka/streams/state/TimestampedKeyValueStore.html) when you need a key-(value/timestamp) store that supports put/get/delete and range queries.
  * Use [TimestampedWindowStore](/static/33/javadoc/org/apache/kafka/streams/state/TimestampedWindowStore.html) when you need to store windowedKey-(value/timestamp) pairs.
...
[Previous](/33/streams/developer-guide/dsl-api) [Next](/33/streams/developer-guide/datatypes)
